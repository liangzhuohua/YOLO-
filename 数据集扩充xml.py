...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_xml_path', type=str, default='./label_xml')
    parser.add_argument('--save_img_path', type=str, default='./Images_2')
    parser.add_argument('--save_xml_path', type=str, default='./label_xml_2')
